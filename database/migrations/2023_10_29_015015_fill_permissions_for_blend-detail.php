...
class FillPermissionsForBlendDetail extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBlendDetail constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.blend-detail',
            'admin.blend-detail.index',
            'admin.blend-detail.create',
            'admin.blend-detail.show',
            'admin.blend-detail.edit',
            'admin.blend-detail.delete',
            'admin.blend-detail.bulk-delete',
        ]);
