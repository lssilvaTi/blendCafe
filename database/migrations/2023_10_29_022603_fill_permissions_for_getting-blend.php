...
class FillPermissionsForGettingBlend extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGettingBlend constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.getting-blend',
            'admin.getting-blend.index',
            'admin.getting-blend.create',
            'admin.getting-blend.show',
            'admin.getting-blend.edit',
            'admin.getting-blend.delete',
            'admin.getting-blend.bulk-delete',
        ]);
