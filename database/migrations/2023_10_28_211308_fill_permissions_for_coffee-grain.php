...
class FillPermissionsForCoffeeGrain extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCoffeeGrain constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.coffee-grain',
            'admin.coffee-grain.index',
            'admin.coffee-grain.create',
            'admin.coffee-grain.show',
            'admin.coffee-grain.edit',
            'admin.coffee-grain.delete',
            'admin.coffee-grain.bulk-delete',
        ]);
